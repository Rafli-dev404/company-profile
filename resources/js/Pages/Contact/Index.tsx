...
import { Phone, Mail, Building2, Users, Award, Layout } from "lucide-react"
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-left mb-16">
            ...
            <p className="text-xl text-black/90 max-w-4xl mx-left leading-relaxed">
              Apabila Anda membutuhkan informasi lebih lanjut, silahkan menghubungi kami melalui kontak yang disediakan
              sesuai kebutuhan.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-20">
                ...
                <div className="text-center flex items-start gap-3">
                  <div>
                    <h4 className="font-semibold text-gray-800">
                      Komplek Sanggar Hurip - Jl. Sanggar Kencana VIII No.3 RT. 001 RW. 003 kelurahan Jatisari,
                      Kecamatan Buah Batu, Kota Bandung, Jawa Barat, 40286
                    </h4>
                  </div>
                </div>
              </CardContent>
            ...
            <Card className="bg-white/95 backdrop-blur-sm shadow-xl">
              <CardHeader className="text-center">
                ...
                <CardDescription className="text-gray-600">Hubungi kami untuk informasi lebih lanjut</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
