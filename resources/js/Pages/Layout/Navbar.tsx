  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <Link href="/about" className="flex items-center hover:text-blue-200 relative z-20">
            About
            <svg
          ...
          {openDropdown === "about" && (
            <div className="absolute left-0 mt-2 w-64 bg-white rounded-md shadow-lg ring-1 ring-black/5 z-50">
        ...
        <div
          ...
          onMouseLeave={() => setOpenDropdown(null)}
        >
          <Link href="/service" className="flex items-center hover:text-blue-200 relative z-20">
            Service
            <svg
          ...
          {openDropdown === "service" && (
            <div className="absolute left-0 mt-2 w-64 bg-white rounded-md shadow-lg ring-1 ring-black/5 z-50">
              ...
              <Link href="/service/1" className="block px-4 py-2 hover:bg-gray-100 text-gray-700">
                Pengembangan Aplikasi
              </Link>
              <Link href="/service/2" className="block px-4 py-2 hover:bg-gray-100 text-gray-700">
                Integrasi Sistem
              </Link>
              <Link href="/service/3" className="block px-4 py-2 hover:bg-gray-100 text-gray-700">
                Deployment Solusi
              </Link>
              <Link href="/service/4" className="block px-4 py-2 hover:bg-gray-100 text-gray-700">
